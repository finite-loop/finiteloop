            ...
            <div>
              <article className="col-span-1 text-sm">
                <p>
                  ...
                  to learn before you can converse with the experts. <br></br>{" "}
                  <br />
                  This is certainly true in astronomy both in terms of terms
                  that refer to the cosmos and terms that describe the tools of
                  the trade, the most prevalent being the telescope. So to get
                  us off of first base, let’s define some of the key terms that
                  pertain to telescopes to help you be able to talk to them more
                  intelligently.{" "}
                </p>
              </article>
            </div>
                ...
                <div className="m-8 my-auto">
                  ...
                  <span>
                    <p className="text-gray-700 text-xs ">
                      ...
                      usually dust or small rocks that come from either a comet
                      or the break up of an asteroid in space and that
                      eventually plummets toward the earth. We say “toward the
                      earth” because the lights you see are the friction of the
                      atmosphere burning up those small space tidbits and
                      creating.
                    </p>
                  </span>
                </div>
            ...
            <div className="p-10 m-10">
              ...
              <div>
                <p className="text-sm text-white">
                  ...
                  a slow computer can have. In addition to being excruciatingly
                  slow when it comes
                </p>
              </div>
            </div>
